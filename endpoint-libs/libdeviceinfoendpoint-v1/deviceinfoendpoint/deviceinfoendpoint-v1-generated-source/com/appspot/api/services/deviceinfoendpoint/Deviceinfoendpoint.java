...
public class Deviceinfoendpoint extends GoogleClient {
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest {
     ...
     *
     * @return the {@link com.appspot.api.services.deviceinfoendpoint.model.DeviceInfoCollection} response
     * @throws IOException if the request fails
     */
    public com.appspot.api.services.deviceinfoendpoint.model.DeviceInfoCollection execute() throws IOException {
      HttpResponse response = executeUnparsed();
      com.appspot.api.services.deviceinfoendpoint.model.DeviceInfoCollection result = response.parseAs(
          com.appspot.api.services.deviceinfoendpoint.model.DeviceInfoCollection.class);
     ...
     *
     * <pre>
       request.queue(batchRequest, new JsonBatchCallback&lt;DeviceInfoCollection&gt;() {

         public void onSuccess(DeviceInfoCollection content, GoogleHeaders responseHeaders) {
           log("Success");
         }
    ...
    public void queue(com.google.api.client.googleapis.batch.BatchRequest batch,
        com.google.api.client.googleapis.batch.json.JsonBatchCallback<com.appspot.api.services.deviceinfoendpoint.model.DeviceInfoCollection> callback)
        throws IOException {
      batch.queue(buildHttpRequest(), com.appspot.api.services.deviceinfoendpoint.model.DeviceInfoCollection.class,
